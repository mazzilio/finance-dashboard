    ...
    return (
        <>
            ...
            <DashboardBox gridArea="h">
                <BoxHeader title="Recent Orders" sideText={`${transactionsData?.length} Transactions`} />{" "}
                <Box
                    mt="1rem"
                    p="0 0.5rem"
                    height="85%"
            ...
            <DashboardBox gridArea="i">
                <BoxHeader title="Expense Breakdown By Category" sideText="+3.2%" />
            ...
            <DashboardBox gridArea="j">
                <BoxHeader title="Overall Summary and Explanation Data" sideText="+13.1%" />{" "}
