                    ...
                    >
                        <defs>
                            <linearGradient id="lineRevenue" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={palette.primary[300]} stopOpacity={0.6} />
                                <stop offset="95%" stopColor={palette.primary[500]} stopOpacity={0.05} />
                            </linearGradient>

                            <linearGradient id="lineExpenses" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={palette.primary[300]} stopOpacity={0.6} />
                                <stop offset="95%" stopColor={palette.primary[500]} stopOpacity={0.05} />
                            </linearGradient>
                        </defs>
                        <XAxis dataKey="name" style={{ fontSize: "12px" }} />
                        <YAxis style={{ fontSize: "12px" }} domain={[8000, 23000]} />
                        <Tooltip />
                        <Area
                            type="monotone"
                            dataKey="revenue"
                    ...
                    >
                        <defs>
                            <linearGradient id="barRevenue" x1="0" y1="0" x2="0" y2="1">
                                <stop offset="5%" stopColor={palette.primary[300]} stopOpacity={0.9} />
                                <stop offset="95%" stopColor={palette.primary[500]} stopOpacity={0.05} />
                            </linearGradient>
                        </defs>
